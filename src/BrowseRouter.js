...
import DiagnosticDashBoard from "./components/DiagnosticDashboard.js";
...
import AddPatientRecords from "./components/AddPatientRecords.js";
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/AboutPage" element={<AboutUs></AboutUs>}></Route>
        ...
        ></Route>
          <Route
          path="/patient/:hhNumber/addRecords"
